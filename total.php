        ...
        <div id="cuerpo" class ="row-fluid" > 
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-10 row-fluid cuerpo-top" >
                        <div><p class="text-pagina"> Total de Inyectadoras</p>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        for($i=1; $i<=$columna; $i++){
                                            ...
                                            echo "<tr>";
                                                echo "<td class=''> $dato[in_cc] cc</td>";
                                                    echo "<td class=''> $dato[in_cantidad]</td>";
                                                ...
                                                echo"<div class='modal-content'>";
                                                        ...
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                echo "<form method='POST' action='eliminar-total.php' name='eliminar-total'>";
                                                                echo " ¿Estas Seguro que quieres eliminar este registro?";
                                                                echo "<input type='hidden' class='form-control' value='$dato[in_cod]' name='in_cod'>   ";
                                                ...
                                                echo"<div class='modal-content'>";
                                                        ...
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                ...
                                                                echo " <form  method='POST' action='editar-total.php' name='editar-total'>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Descripcion</label>";
                                                                        echo "<input type='text' class='form-control' name='in_cc' placeholder='$dato[in_cc]'>";
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                                                                        echo " <br>¿Estas seguro que quieres editar ";
                                                                            echo "<input type='hidden' class='form-control' value='$dato[in_cod]' name='in_cod' placeholder=''>   ";
                                                                    echo "</div>";
                                                            echo "</div>";
                                                        echo "<div class='modal-footer'>";
                                                        echo "<button type='button' class='btn btn-default' data-dismiss='modal'>Cerrar</button>";
                         ...
                         <button type="button" class="btn btn-success " data-toggle="modal" data-target=".bs-example-modal-sm">
                            Nueva Inyectadora <span class="glyphicon glyphicon-plus"> </span> 
                        </button>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">Inyectadora</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form  method="POST" action="ingreso-total.php" name="ingreso-total">
                                            <div class="form-group">
                                                <label>tipo de CC</label>
                                                <input type="text" class="form-control" name="in_cc" placeholder="CC">
                                                <input type="hidden" class="form-control" name="in_cantidad" value ="0">
                                            </div>
                                    </div>
