                    ...
                    <div class='modal-dialog '>
                        <div class='modal-body'>
                            <div class=' alert alert-danger'>
                                Este Unidad ya fue registrada <span class='glyphicon glyphicon-'></span>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-10 row-fluid cuerpo-top" >
                                        ...
                                        for($i=1; $i<=$columna; $i++){
                                                ...
                                                echo"<div class='modal-content'>";
                                                        echo "<div class='modal-header'>";
                                                            echo "<button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>";
                                                                echo "<h4 class='modal-title' id='myModalLabel'>Eliminar Unidad</h4>";
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                echo "<form method='POST' action='eliminar-unidad.php' name='eliminar-unidad'>";
                                                                echo " ¿Estas Seguro que quieres eliminar $dato[u_nombre]?";
                                                                echo "<input type='hidden' class='form-control' value='$dato[u_cod]' name='u_cod'>   ";  
                                            ...
                                            echo "<div class='modal fade' id='bs-edit-modal-sm$i' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel' aria-hidden='true'>";
                                                ...
                                                echo"<div class='modal-content'>";
                                                        echo "<div class='modal-header'>";
                                                            echo "<button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>";
                                                                echo "<h4 class='modal-title' id='myModalLabel'>Editar Unidad</h4>";
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                
                                                                echo " <form  method='POST' action='editar-unidad.php' name='editar-unidad'>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Nombre </label>";
                                                                        echo "<input type='text' class='form-control' name='u_nombre' value='$dato[u_nombre]'>";
                                                                        echo "<input type='hidden' class='form-control' name='u_cod' value='$dato[u_cod]'>";
                                                                    echo "</div>";
                        ...
                        <button type="button" class="btn btn-success " data-toggle="modal" data-target=".bs-example-modal-sm">
                            Nueva Unidad <span class="glyphicon glyphicon-plus"> </span> 
                        </button>
                        ...
                        <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form  method="POST" action="ingreso-unidad.php" name="ingreso-unidad">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" class="form-control" required name="u_nombre">
                                            </div>                      
                                    </div>
