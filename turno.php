                    ...
                    <div class='modal-dialog '>
                        <div class='modal-body'>
                            <div class=' alert alert-danger'>
                                La cantidad que quiere repartir es mayor que se posee <span class='glyphicon glyphicon-'></span>
        ...
        <div id="cuerpo" class ="row-fluid" > 
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-10 row-fluid cuerpo-top" >
                        <div><p class="text-pagina"> Turno</p>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        for($i=1; $i<=$columna; $i++){
                                            ...
                                            echo "<tr>";
                                                $date = date_create($dato['inturno_fecha']);
                                                $date2 = date_format($date, 'd-m-Y');
                                                echo "<td class=''> $date2</td>";
                                                echo "<td class=''> $dato6[in_cc] cc</td>";
                                                echo "<td class=''> $dato[inturno_ts] </td>";
                                                echo "<td class=''> $dato[inturno_ts] </td>";
                                                echo "<td class=''> $dato[inturno_ns]</td>";
                                                echo "<td class=''> $dato[inturno_total] </td>";
                                                ...
                                                echo"<div class='modal-content'>";
                                                        echo "<div class='modal-header'>";
                                                            echo "<button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>";
                                                                echo "<h4 class='modal-title' id='myModalLabel'>Eliminar Registro</h4>";
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                echo "<form method='POST' action='eliminar-turno.php' name='eliminar-turno'>";
                                                                echo " ¿Estas Seguro que quieres eliminar este registro?";
                                                                echo "<input type='hidden' class='form-control' value='$dato[inturno_cod]' name='inturno_cod'>   ";
                                                ...
                                                echo"<div class='modal-content'>";
                                                        ...
                                                        echo "</div>";
                                                            echo "<div class='modal-body'>";
                                                                ...
                                                                echo " <form  method='POST' action='editar-turno.php' name='editar-turno'>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Fecha</label>";
                                                                        echo "<input type='text' class='form-control' name='inturno_fecha' value='$date2'>";
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                                                                    ...
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Mañana</label>";
                                                                        echo "<input type='text' class='form-control' name='inturno_dia' value='$dato[inturno_dia]'>";
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Tarde</label>";
                                                                        echo "<input type='text' class='form-control' name='inturno_ts' value='$dato[inturno_ts]'>";
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                                                                        echo "<label>Noche</label>";
                                                                        echo "<input type='text' class='form-control' name='inturno_ns' value='$dato[inturno_ns]'>";
                                                                    echo "</div>";
                                                                    echo "<div class='form-group'>";
                        ...
                        <?php 
                            ...
                            $sql9 = "SELECT * FROM in_general";
                            $result9 = pg_query($sql9) or die('ERROR BD');
                            $dato9 = pg_fetch_array($result9);

                            if($dato8==null) { ?>
                                <a class="btn btn-success" href="total.php" role="button" >
                                    Preciona aqui para agregar una Inyectadora <span class="glyphicon glyphicon-plus"> </span> 
                                </a>
                            <?php } elseif($dato9==null){ ?>
                                <a class="btn btn-success" href="general.php" role="button" >
                                    Preciona aqui para agregar una solicitud de Inyectadora <span class="glyphicon glyphicon-plus"> </span> 
                                </a>
                            <?php }else { ?>
                                    ...
                                    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form  method="POST" action="ingreso-turno.php" name="ingreso-turno">         
                                                        <?php     
                                                            echo "<div class='form-group'>";
                                                                echo "<label>Descripcion</label>";
                                                                    echo "<select class='form-control' name='in_cod'>";
                                                                        $sql7 = 'SELECT * FROM inyectadoras';
                                                                        $result7 = pg_query($sql7) or die('ERROR BD');              
                                                                        $columna7 = pg_numrows($result7);
                                                                            for($i7=1; $i7<=$columna7; $i7++){
                                                                                $dato7 = pg_fetch_array($result7);
                                                                                    echo "<option value='$dato7[in_cod]'>$dato7[in_cc] cc ";
                                                                                    echo "</option>";
                                                                            }
                                                                    echo "</select>";
                                                            echo "</div>";
                                                        ...
                                                        <div class="form-group">
                                                            <label>Mañana</label>
                                                            <input type="number" required class="form-control" name="inturno_dia">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Tarde</label>
                                                            <input type="number" required class="form-control" name="inturno_ts">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Noche</label>
                                                            <input type="number" required class="form-control" name="inturno_ns">
                                                        </div>
